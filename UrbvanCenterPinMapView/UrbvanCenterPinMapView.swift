...
public protocol UrbvanCenterPinMapViewDelegate {
...
public class UrbvanCenterPinMapView: UIView {
    ...
    /// UrbvanCenterPinMapView's delegate. You can declare your customized delegate for more specific behaviour
    public var delegate: UrbvanCenterPinMapViewDelegate?
    ...
    /// This method should be called when the view containing UrbvanCenterPinMapView frame changes or when the MapView's layoutMargins are updated to update the Center Pin Position to the new Center.
    ...
    /// If you want to create your own delegate for UrbvanCenterPinMapView but still keep the core functionality you can call this method on your custom mapView(_ mapView: MKMapView, regionWillChangeAnimated animated: Bool) and mapView(_ mapView: MKMapView, regionDidChangeAnimated animated: Bool)
    ...
    /// Sets up UrbvanCenterPinMapView
    private func setup() {
...
extension UrbvanCenterPinMapView: MKMapViewDelegate {
